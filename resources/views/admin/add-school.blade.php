    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.store-school') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="d-flex align-items-start gap-3">
                                    <div class="logo-preview" id="logoPreview">
                                        <div class="placeholder-logo">
                                            ...
                                            <p class="mt-2 mb-0 text-muted">No logo selected</p>
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="form-text">
                                            Upload a school logo (JPG, PNG, GIF. Max: 2MB)
                                        </div>
                                        @error('logo')
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>Add School
                            </button>
                        </div>
                    </form>
                </div>
